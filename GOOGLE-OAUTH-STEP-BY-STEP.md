# Google Drive / OAuth setup — Local Wealth Manager v1.6
...
> **Important:** You do not give Local Wealth Manager your Google password. You sign in directly in Google's authorization window. The app receives an OAuth access token. Your master password is never sent to Google.
...
Sign in using the Google account that you want to use with Local Wealth Manager.
...
7. Select the new **Local Wealth Manager** project from the project selector.
...
1. In Google Cloud Console, make sure **Local Wealth Manager** is selected.
...
# Part 8 — Put the credentials into Local Wealth Manager

Open the Local Wealth Manager HTTPS URL.
...
4. Allow access.
5. Local Wealth Manager opens Google Picker.
