const CACHE='finmate-pwa-v2.0';
const ASSETS=['./','./index.html','./app.css','./app.js','./manifest.webmanifest','./icons/finmate-icon-192.png?v=2.0','./icons/finmate-icon-512.png?v=2.0'];
