const CACHE='finmate-pwa-v3.19';
const ASSETS=['./','./index.html','./app.css','./app.js','./manifest.webmanifest','./oauth-config.js','./favicon.png','./icons/finmate-icon-48.png','./icons/finmate-icon-192.png','./icons/finmate-icon-512.png'];
