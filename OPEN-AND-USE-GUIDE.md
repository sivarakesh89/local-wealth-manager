# Local Wealth Manager v1.6 — How to open and use it
...
4. Extract the downloaded Local Wealth Manager ZIP on your laptop first.
...
4. Press Enter.
5. You should see **Local Wealth Manager — Unlock your vault** if you already created a vault in that browser, or the **Welcome** screen if this browser has not used the app before.
...
2. The app shows **Welcome to Local Wealth Manager**.
...
9. An app icon named **Local Wealth Manager** appears on your Home screen/app drawer.
